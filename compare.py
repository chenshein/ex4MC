...
SLEEP_PERIOD = 0.25 if os.system("timeout 0.25 ls > /dev/null 2>/dev/null") == 0 else 1
...
def main():
    ...
    curl 'https://docs.google.com/forms/d/e/1FAIpQLScIN4njh40n6osL4Ag4qJf5RsS88_q6NqEHYwWJeI-Wn1seJw/formResponse' \
      ...
      --data-raw "{'&'.join(entries_data)}&fvv=1&partialResponse=%5Bnull%2Cnull%2C%224387170321690009457%22%5D&pageHistory=0&fbzx=4387170321690009457" \
          --compressed > /dev/null
        """)
